...
Mobile.verifyElementVisible(findTestObject('transliterasi/hasil_text_aksara'), 0)

Mobile.verifyElementVisible(findTestObject('transliterasi/hasil_text_ulu'), 0)

Mobile.verifyElementVisible(findTestObject('transliterasi/hasil_translasi'), 0)

...
Mobile.verifyElementVisible(findTestObject('riwayat/h2_kasih_feedback'), 60)

Mobile.verifyElementVisible(findTestObject('riwayat/text_deskripsi_feedback'), 60)

Mobile.tap(findTestObject('riwayat/button_opsi_ya'), 60)

Mobile.verifyElementVisible(findTestObject('riwayat/popup_berhasil_kirim'), 60)
